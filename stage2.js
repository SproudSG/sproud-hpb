...
export const stage2 = (() => {
    ...
    class BasicWorldDemo {
        constructor() {
            ...
            this.gender_ = null;
            document.getElementById('video-container').onclick = () => this._OnStart();
        ...
        GetCompletionStatus(callback) {
            const result = this.nextStage_;
            callback(result);
        }
